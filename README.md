...
## ⏱️ What you get vs. what it costs to build yourself
...
One codebase serves unlimited tenants. Domains resolve via `*.yourdomain.com` wildcard DNS or fully custom domains (`client.com`). Tenant config cached in Redis, refreshed automatically.

---

## 🖼️ What's included (screenshots)
...
```
.
├── app/                    # Next.js 16 App Router (admin + tenant public pages)
...
├── supabase/
│   ├── setup_saas_core.sql # Complete DDL: tables, RLS, triggers, functions
│   └── seed_saas_core.sql  # Demo tenants, roles, and sample data
├── docs/
│   ├── INSTALLATION_GUIDE.md
│   └── COMMERCIAL_PRODUCT_DOCS.md
...
# → Run: supabase/setup_saas_core.sql
# → Run: supabase/seed_saas_core.sql
...
For full production deployment (Vercel + Wildcard DNS), see **[INSTALLATION_GUIDE.md](docs/INSTALLATION_GUIDE.md)**.
...
| Database | Supabase (PostgreSQL 15+, pgvector, PostGIS) |
...
| :--- | :--- |
| [INSTALLATION_GUIDE.md](docs/INSTALLATION_GUIDE.md) | Step-by-step deployment guide (local + Vercel production) |
...
| [08_INCIDENT_RESPONSE_RUNBOOK.md](docs/08_INCIDENT_RESPONSE_RUNBOOK.md) | SOC incident handling and threat response playbooks |
| [25_ISO27001_COMPLIANCE_GUIDE.md](docs/25_ISO27001_COMPLIANCE_GUIDE.md) | ISO 27001 compliance mapping for enterprise audits |
